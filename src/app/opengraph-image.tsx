...
export const alt = 'DoppelShield / URL Forensics & Homograph Detection';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

export default async function Image() {
    const [chakraPetch, electrolize] = await Promise.all([
    ...
    return new ImageResponse(
        ...
        >
            ...
            >
                ...
                >
                    <span style={{ color: '#f1f5ea' }}>DOPPEL</span>
                    <span style={{ color: '#828b74' }}>SHIELD</span>
                </div>
            </div>
            <div
                style={{
